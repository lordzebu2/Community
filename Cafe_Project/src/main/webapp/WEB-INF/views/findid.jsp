...
<body>
	<div class="wrap">
		<form action="findid_proc.do" method="post">
			<div class="main">			
				<h1 style="text-align: center; width: 100%;">아이디 찾기</h1>
				<div class="main_id">
					<div style="width: 10%; padding: 7px; font-weight: bold;">이름</div>
					<input type="text" style="font-size: 15px;" name="name">
				</div>
				<div class="main_pw">
					<div style="width: 10%; padding: 7px; font-weight: bold;">email</div>
					<input type="text" style="font-size: 15px;" name="email">
				</div>
				<div class="main_info">
					<a href="main.do" style="color: gray;">　홈으로　</a>
					<div>　|</div>
					<a href="findpw.do" style="color: gray;">비밀번호 찾기</a>
				</div>
